                ...
                <div className="view_customer_sale_product_invoice_list">
                    ...
                    <div className="view_customer_sale_product_invoice_detail">
                        ...
                        <div className="view_customer_sale_product_invoice_add_sale">
                            <Link to='/add-expense' className='btn btn-primary'>Add Expenses</Link>
                        </div>
                    </div>
                        ...
                        <table>
                            <tbody>
                                <tr className="table_header">
                                    ...
                                    <th>
                                        <div class="fields_with_filter"><span>Exp No</span><i class="fas fa-filter"></i></div>
                                    </th>
                                    <th>
                                        <div class="fields_with_filter" ><span>Part </span><i class="fas fa-filter"></i></div>
                                    </th>
                                    <th>
                                        <div class="fields_with_filter" ><span>Category</span><i class="fas fa-filter"></i></div>
                                    </th>
                                    <th>
