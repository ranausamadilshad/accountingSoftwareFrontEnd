                        ...
                        <table>
                            <tbody>
                                <tr className="table_header">
                                    ...
                                    <th>
                                        <div class="fields_with_filter"><span>Sale Discount</span></div>
                                    </th>
                                    <th>
                                        <div class="fields_with_filter" ><span>Purchase/Expense Discount</span></div>
                                    </th>
                                </tr>
                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-2">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4">
                                    <p>Total Sale Amount Rs.00</p>
                                 </div>
                                 <div class="col-lg-2 col-md-2 col-sm-2">
                                 </div>
                                 <div class="col-lg-4 col-md-4 col-sm-4">
                                 <p>Total Purchase Amount Rs.00</p>
                                 </div>
                        </div>
                    </div>
                </div>
...
export default DiscountReportScreen
