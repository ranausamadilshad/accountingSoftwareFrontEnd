                ...
                <div className="view_customer_sale_body_detail_one">
                    <div className="view_customer_sale_selection_fields">
                        <div className="view_customer_sale_selection_box">
                            <div className="customer_sale_single_between_selection_box"  style={{display:"column"}}>
                                <h6>From</h6>
                                <input type="date" />
                                <h6>To</h6>
                                <input type="date" />
                        ...
                        <table>
                            <tbody>
                                <tr className="table_header">
                                    ...
                                    <th>
                                        <div class="fields_with_filter"><span>Sale Quantity</span></div>
                                    </th>
                                    <th>
                                        <div class="fields_with_filter" ><span>Purchase Qty</span></div>
                                    </th>
                                    <th>
                                        <div class="fields_with_filter" ><span>Adjustment Qty</span></div>
                                    </th>
                                    <th>
                                        <div class="fields_with_filter" ><span>Closing Value</span></div>
                                    </th>
                                </tr>
